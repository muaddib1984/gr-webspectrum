...
class RTLSDR_or_fake_signal_to_fft_to_broadcaster(gr.top_block):
    ...
    def __init__(self, fft_size=8192, frequency=100e6, gain=40.0, samp_rate=2.88e6):
        ...
        self.webspectrum_broadcaster_0 = webspectrum.broadcaster(2.88e6, 100e6, 40.0, 8192, 'localhost', 6379, 'spectral')
...
def main(top_block_cls=RTLSDR_or_fake_signal_to_fft_to_broadcaster, options=None):
    if options is None:
